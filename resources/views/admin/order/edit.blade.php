...
$(document).ready(function() {
   ...
   // --- UPDATED CALCULATION LOGIC WITH ROUNDING UP ---
   function calculateFinalTotals() {
        ...
        // --- NEW LOGIC: Round UP to next integer ---
